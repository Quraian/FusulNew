...
// This code is copied from: https://github.com/blakeembrey/change-case/blob/main/packages/title-case/src/index.ts
// The reason is that Jest fails because the library is ESM only
// You can use it once vitest is used instead
